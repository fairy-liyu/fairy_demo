<template>
  <div class="BMap">
    ...
    <div id="mapPanel">
      <div style="text-align: center; padding-top: 200px; color: #fff">
        地图加载中...
      </div>
    </div>
    <div id="m-result">
      ...
      <el-button class="confirm" @click="submitAdd">确定</el-button>
    </div>
    ...
    <div class="poiList" id="poiPanel" v-if="poiShow">
      <div class="content">
        <ul>
          <li v-for="(poi, index) in poiList.data" @click="getPoi(poi)" :key="index">
