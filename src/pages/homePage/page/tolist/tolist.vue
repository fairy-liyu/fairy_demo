<template>
    <div style="position: relative;">
        <div>
            <fairy-title :text="'tolist'" :icon="'icon-column1'"></fairy-title>
        </div>
         <div class="leftCenter">
             <el-input v-model="msg" style="width: 300px;margin-top: 70px" placeholder="请输入内容"></el-input><el-button class="btn blue-button" style="padding-bottom: 6px" @click="savetolist">确定</el-button>
         </div>
        <div class="leftCenter" style="top: 127px;line-height: 42px;font-size: 22px;color: #2b3b4b">
            <p v-for="(data, index) in toListData" :key="index">
                {{data}}
            </p>
        </div>
