<template>
  <div id="datepaick">
    <div>
      <fairy-title :text="'日历本'" :icon="'icon-calendar'"></fairy-title>
    </div>
    <div class="flex">
      <div>
        <span>弹出框</span>
      ...
      <div>
        ...
        ></calendar>
        <el-button class="blue-bgw-button" @click="changeEvents"
          >异步更新Price</el-button
        >&emsp;
        <el-button
          class="blue-bgw-button"
          @click="
            calendar1.value = [2018, 1, Math.floor(Math.random() * 30 + 1)]
          "
          >动态设置日期</el-button
        >&emsp;
        <el-button class="blue-bgw-button" @click="$refs.calendar1.setToday()"
          >返回今天</el-button
        >
      </div>
