<template>
  <div>
    ...
    <div class="flt">
      <fairy-chart :defOptions="options" :styles="sty"></fairy-chart>
    </div>
    <div class="flt">
      <fairy-chart :defOptions="optionsn" :styles="sty"></fairy-chart>
    </div>
    <div class="flt">
      <fairy-chart :defOptions="optionsex" :styles="sty"></fairy-chart>
    </div>
    <div class="flt">
      <fairy-chart :defOptions="optionslogar" :styles="sty"></fairy-chart>
    </div>
  </div>
</template>

<script>
import fairyChart from "@/components/fairyChart.vue";
export default {
  name: "highcharts",
  components: {
    fairyChart,
  ...
  data() {
    return {
      ...
      optionsex: {
        ...
        xAxis: {
          categories: ["0-18", "19-28", "29-38", "39-48", "49-58", "59以上"],
          crosshair: true,
        },
        yAxis: {
          title: {
      ...
      options: {
        ...
        tooltip: {
          ...
          //格式化悬浮显示框
          pointFormat:
            '热度<b style="color:#0ac6f2;margin: 0 auto 0 10px">{point.y}</b><br/>',
          style: {
            // 文字内容相关样式
            color: "#ffffff",
            fontSize: "12px",
